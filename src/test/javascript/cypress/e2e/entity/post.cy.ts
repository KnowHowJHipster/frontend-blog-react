...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'faithful', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-06-03T04:29:50.490Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('mean inquisitively');
      cy.get(`[data-cy="title"]`).should('have.value', 'mean inquisitively');
      ...
      cy.get(`[data-cy="date"]`).type('2024-06-02T23:31');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-06-02T23:31');
