...
describe('Blog e2e test', () => {
  ...
  const blogSample = { name: 'against slimy that', handle: 'supposing keep' };
  ...
  describe('new Blog page', () => {
    ...
    it('should create an instance of Blog', () => {
      cy.get(`[data-cy="name"]`).type('legislation');
      cy.get(`[data-cy="name"]`).should('have.value', 'legislation');

      cy.get(`[data-cy="handle"]`).type('cylindrical ouch');
      cy.get(`[data-cy="handle"]`).should('have.value', 'cylindrical ouch');
